function [Fitt,Alpha,Beta,Pxx,FrequencySpectrum,LogFreq,LogSpectrum]=Vangjush_F_slope(x,T,Fre_Thre1,Fre_Thre2)
%%
...
%%
[~,pos1]=min(abs(FrequencySpectrum-Fre_Thre1));  % Retrieve the position of the first threshold frequency
[~,pos2]=min(abs(FrequencySpectrum-Fre_Thre2));  % Retrieve the position of the second threshold frequency
